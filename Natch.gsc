...
init_custom_map()
{
	...
	door();
    noncollision( "script_model", ( 12871.65, -618.14, -186.3518 ), "collision_player_wall_512x512x10", ( 0, -90, 0 ), "collisionwall" );
	perk_system( "script_model", ( 13804.28, -210, -188.875 ), "zombie_vending_revive_on", ( 0, 0, 0 ), "revive" );
	perk_system( "script_model", ( 12957.28, -1020, -202.875 ), "zombie_vending_jugg_on", ( 0, 90, 0 ), "original", "mus_perks_jugganog_sting", "Jugger-Nog", 2500, "jugger_light", "specialty_armorvest" );
	perk_system( "script_model", ( 13526, -522, -188.875 ), "zombie_vending_marathon_on", ( 0, -90, 0 ), "original", "mus_perks_stamin_sting", "Stamin-Up", 2000, "marathon_light", "specialty_longersprint" );
    perk_system( "script_model", ( 13593, -1295, -188.875 ), "zombie_vending_sleight_on", ( 0, 0, 0 ), "original", "mus_perks_speed_sting", "Speed Cola", 3000, "sleight_light", "specialty_fastreload" );
    perk_system( "script_model", ( 13975.1, -1530.29, -189.8062 ), "zombie_vending_doubletap2_on", ( 0, -90, 0 ), "original", "mus_perks_doubletap_sting", "Double Tap Root Beer", 2000, "doubletap_light", "specialty_rof" );
    perk_system( "script_model", ( 12865.8, -661, -186.5195 ), "p6_anim_zm_buildable_pap_on", ( 0, 90, 0 ), "pap", "zmb_perks_packa_upgrade", "Pack-A-Punch", 5000 );
	perk_system( "script_model", ( 13341.8, 85.9, -189.0379 ), "zombie_vending_tombstone_on", ( 0, 0, 0 ), "random", "mus_perks_speed_sting", "Random Perk", 1500, "sleight_light" );
}
...
{
	level.doorcost = 1000;
	door_model = spawn( "script_model", ( 13550.03, -994.05, -197.875 ) );
	door_model setmodel( "p_rus_door_white_window_plain_left" );
	door_model.angles = (0, -90, 0);
    door_col = spawn( "script_model", ( 13550.03, -994.05, -197.875 ) );
    door_col setmodel( "collision_player_wall_512x512x10" );
    door_col.angles = (0, -90, 0);
    door_model2 = spawn( "script_model", ( 13550.03, -321.05, -187.875 ) );
	door_model2 setmodel( "p_rus_door_white_window_plain_left" );
	door_model2.angles = (0, -90, 0);
    door_col2 = spawn( "script_model", ( 13550.03, -321.05, -187.875 ) );
    door_col2 setmodel( "collision_player_wall_512x512x10" );
    door_col2.angles = (0, -90, 0);
    door_model thread open_door( door_model, door_col, door_model2, door_col2 );
    door_model2 thread open_door( door_model, door_col, door_model2, door_col2 );
}

open_door( door_model, door_col, door_model2, door_col2 )
{
	while( 1 )
	{
		foreach( player in level.players )
...
soul_box(model)
{
	...
	level.soulbox = spawnentity( "script_model", getweaponmodel( model ), ( 13362.03, -104.05, -188.875 ), ( 0, 0, 0 ));
	level.soulbox1 = spawnentity( "script_model", getweaponmodel( model ), ( 13135.65, -702.551, -202.5 ), ( 0, 0, 0 ));
	level.soulbox2 = spawnentity( "script_model", getweaponmodel( model ), ( 13795, -1083.551, -181.875 ), ( 0, 0, 0 ));
}
...
box_init() 
{
	...
	start_chest.origin = ( 13676, -1182, -188.875 );
...
get_chest_pieces()
{
	...
	self.chest_box.origin = ( 13676, -1182, -188.875 );
...
boss_round_monitor()
{
    ...
    power_up = [];
	power_up[0] = "nuke";
	power_up[1] = "double_points";
	power_up[2] = "full_ammo";
	power_up[3] = "random_perk";
	power_up[4] = "death_machine";
	power_up[5] = "zombie_cash";
	power_up[6] = "unlimited_ammo";
